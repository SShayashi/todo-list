# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-08-13 07:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('list', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Tasks', to='cms.List', verbose_name='List')),
            ],
        ),
        migrations.AddField(
            model_name='comment',
